...
var ctThemeXP2 =
{
	...
	folderLeft: [['<img alt="" src="' + ctThemeXPBase + 'forderopen1.gif" />', '<img alt="" src="' + ctThemeXPBase + 'forderopen1.gif" />']],
	...
	spacer: [['',''],['<img alt="" src="' + ctThemeXPBase + 'line2.gif" />', '<img alt="" src="' + ctThemeXPBase + 'spacer.gif" />']],
