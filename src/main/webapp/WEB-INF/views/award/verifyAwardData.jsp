...
<body id="scroller">
	<h1><span class="title-l">票券批號(得標確認)待審核清冊</span></h1>
	...
	<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <c:if test="${resultList.totalElements > 0}">	     
		...
		<c:if test="${resultList.totalElements == 0}">
		     <tr>
			     <td colspan="12">
			           <font size="3" color="red">無任何票券批號(得標確認)待審核資料</font>
			      </td>
			 </tr>
		</c:if>       		  
	    </table>
 ...
 <table width="88%" border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <form:form id="showDetailAwardDataForm" name="showDetailAwardDataForm" action="awardDataVerify/doDetail">
